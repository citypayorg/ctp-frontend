...
// ABI
import profileABI from 'config/abi/ctpProfile.json'
import ctpRabbitsAbi from 'config/abi/ctpRabbits.json'
...
export const getPancakeRabbitContract = (web3?: Web3) => {
  return getContract(ctpRabbitsAbi, getPancakeRabbitsAddress(), web3)
}
