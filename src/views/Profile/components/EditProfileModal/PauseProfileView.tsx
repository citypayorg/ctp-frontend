...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@ctpswap/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  const ctpProfileContract = useProfileContract()
