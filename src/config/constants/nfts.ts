...
const Nfts: Nft[] = [
  {
    name: 'Mixie v1',
    description: 'Stories were told, and songs were sung, about Chef Mixie’s ctps and her big Syrup gun.',
    images: {
      lg: 'mixie-1-lg.png',
      md: 'mixie-1-md.png',
      sm: 'mixie-1-sm.png',
  ...
  {
    name: 'Sleepy',
    description: 'Aww, looks like eating ctps all day is tough work. Sweet dreams!',
    images: {
      lg: 'sleepy-lg.png',
      md: 'sleepy-md.png',
      sm: 'sleepy-sm.png',
  ...
  {
    name: 'Sunny',
    description: 'Sunny is always cheerful when there are ctps around. Smile!',
    images: {
      lg: 'sunny-lg.png',
      md: 'sunny-md.png',
      sm: 'sunny-sm.png',
  ...
  {
    name: 'Swapsies',
    description: 'These bunnies love nothing more than swapping ctps. Especially on BSC.',
    images: {
      lg: 'swapsies-lg.png',
      md: 'swapsies-md.png',
      sm: 'swapsies-sm.png',
  ...
  {
    name: 'Blueberries',
    description: "These bunnies like their ctps with blueberries. What's your favorite topping?",
    images: {
  ...
  {
    name: 'Circular',
    description: "Love makes the world go 'round... but so do ctps. And these bunnies know it.",
    images: {
      lg: 'circular-lg.png',
      md: 'circular-md.png',
      sm: 'circular-sm.png',
  ...
  {
    name: 'Sparkle',
    description: 'It’s sparkling syrup, ctps, and even lottery tickets! This bunny really loves it.',
    images: {
      lg: 'sparkle-lg.png',
      md: 'sparkle-md.png',
      sm: 'sparkle-sm.png',
